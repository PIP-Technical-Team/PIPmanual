...
![subtree_folder](img/subtree_folder.png)
...
Alternatively, you can invoke **Remote\|Pull** from the main menu and for
**Fetch From** select the subtree remote there.
...
2.  In the **Branches** view, select the subtree branch to which the changes
...
3.  To push changes back to your remote subtree repository, tracking between the
