...
The name of the variables in the wide-format file will follow
this structure, ppp_YYYY_vX_vY. Where,

-   YYYY:
    refers to the ICP round.

-   vX:
        refers to the version of the release.

-   vY:   
    refers to the adaptation of the release. So, v1 will be the original data,
    whereas v2 would be the first adaptation or estimates of the release.
...
`pipaux::pip_ppp_clean()` , in particular in the lines below:
