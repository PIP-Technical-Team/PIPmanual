...
[NOTE:Minh: Could you please add (or ask someone to add) a short explanation for each variable? Just follow the same line of explanations as the ones already done.]{style="color:red"}
