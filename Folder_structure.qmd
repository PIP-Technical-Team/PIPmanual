...
The PIP root directory (`Sys.getenv("PIP_ROOT_DIR")`) contains the following main folders. Description of each of them and their subfolders are provided below.
