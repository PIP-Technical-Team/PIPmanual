...
**Step 13:** If you conducted a data update that includes changes to survey data or the estimation tables for an already
existing version folder you will need to clear the cache on the VM. Use the specific API endpoints for cache handling to do this. 
...
**Step 8:** Clear the cache on the VMs if needed. [Note: If in doubt always clear the cache.]{style="color:red"}
