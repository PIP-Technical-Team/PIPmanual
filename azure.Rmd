...
**Step 2:** Nagivate to the Azure DevOps data repo (insert link). Click on Pipelines. 
...
**Step 1:** Nagivate to the Azure DevOps data repo (insert link).
...
**Step 3:** Go Pipelines -> Pipelines. Trigger the ACR-DEV-CI pipeline, either by a) Pushing an updated Dockerfile to the remote repo or b) Running the Pipeline manually. 
...
**Step 5:**. Vist the [DEV API website] (insertlink) for further testing. 
...
**Step 3:** Create a pull request from DEV to QA.G o through the steps to commit and approve the pull request.
...
**Step 5:**  Vist the QA API website (insertlink) for further testing.
